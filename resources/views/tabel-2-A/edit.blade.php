...
<div class="row">
    <div class="col-12">
        ...
        <div class="card">
            <form action="{{ route('tabel-2-a.update', $tabel_2_a->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="card-body">
                    <h4 class="card-title">Ubah Data Seleksi Mahasiswa</h4>
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <select name="tahun_akademik" class="form-select">
                                <option value="{{ $tabel_2_a->tahun_akademik }}">{{ $tabel_2_a->tahun_akademik }}</option>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="number" value="{{ $tabel_2_a->daya_tampung }}" name="daya_tampung" id="daya_tampung">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="number" value="{{ $tabel_2_a->jumlah_calon_mahasiswa_pendaftar }}" name="jumlah_calon_mahasiswa_pendaftar" id="jumlah_calon_mahasiswa_pendaftar">
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="jumlah_calon_mahasiswa_lulus_seleksi" class="col-md-2 col-form-label">Lulus Seleksi</label>
                        <div class="col-md-10">
                            <input class="form-control" type="number" value="{{ $tabel_2_a->jumlah_calon_mahasiswa_lulus_seleksi }}" name="jumlah_calon_mahasiswa_lulus_seleksi" id="jumlah_calon_mahasiswa_lulus_seleksi">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="number" value="{{ $tabel_2_a->jumlah_mahasiswa_baru_reguler }}" name="jumlah_mahasiswa_baru_reguler" id="jumlah_mahasiswa_baru_reguler">
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="jumlah_mahasiswa_baru_transfer" class="col-md-2 col-form-label">Transfer</label>
                        <div class="col-md-10">
                            <input class="form-control" type="number" value="{{ $tabel_2_a->jumlah_mahasiswa_baru_transfer }}" name="jumlah_mahasiswa_baru_transfer" id="jumlah_mahasiswa_baru_transfer">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="number" value="{{ $tabel_2_a->jumlah_mahasiswa_aktif_reguler }}" name="jumlah_mahasiswa_aktif_reguler" id="jumlah_mahasiswa_aktif_reguler">
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="jumlah_mahasiswa_aktif_transfer" class="col-md-2 col-form-label">Transfer</label>
                        <div class="col-md-10">
                            <input class="form-control" type="number" value="{{ $tabel_2_a->jumlah_mahasiswa_aktif_transfer }}" name="jumlah_mahasiswa_aktif_transfer" id="jumlah_mahasiswa_aktif_transfer">
                        </div>
                    </div>
