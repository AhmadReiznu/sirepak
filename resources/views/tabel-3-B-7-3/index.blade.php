...
@slot('title') Bagian-3 Teknologi Tepat Guna, Produk, Karya Seni, Rekayasa Sosial @endslot
@endcomponent

<button class="btn btn-success mb-4">
    <a href="{{ route('tabel-3-b-7-3.create') }}" class="text-white">Tambah</a>
</button>
