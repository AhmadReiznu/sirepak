...
<div class="row">
    <div class="col-12">
        ...
        <div class="card">
            <form action="{{ route('tabel-3-b-7-3.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    @if(count($errors) > 0)
                    <div class="row">
                    ...
                    @endif
                    <h4 class="card-title">Tambah Data Bagian-3 Teknologi Tepat Guna, Produk, Karya Seni, Rekayasa Sosial</h4>
                    <div class="mb-3 row">
