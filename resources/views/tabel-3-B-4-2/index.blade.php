...
@slot('title') Pagelaran/Pameran/Presentasi/Publikasi Ilmiah DTPS @endslot
@endcomponent

<button class="btn btn-success mb-4">
    <a href="{{ route('tabel-3-b-4-2.create') }}" class="text-white">Tambah</a>
</button>
