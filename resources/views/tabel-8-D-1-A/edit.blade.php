...
<div class="row">
    <div class="col-12">
        ...
        <div class="card">
            <form action="{{ route('tabel-8-d-1-a.update', $tabel_8_d_1_a->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="card-body">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <select name="tahun_lulus" class="form-select">
                                <option value="{{ $tabel_8_d_1_a->tahun_lulus }}" class="text-capitalize">{{ $tabel_8_d_1_a->tahun_lulus }}</option>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="number" value="{{ $tabel_8_d_1_a->jumlah_lulusan }}" name="jumlah_lulusan" id="jumlah_lulusan">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="number" value="{{ $tabel_8_d_1_a->jumlah_lulusan_yang_terlacak }}" name="jumlah_lulusan_yang_terlacak" id="jumlah_lulusan_yang_terlacak">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="number" value="{{ $tabel_8_d_1_a->jumlah_lulusan_yang_dipesan_sebelum_lulus }}" name="jumlah_lulusan_yang_dipesan_sebelum_lulus" id="jumlah_lulusan_yang_dipesan_sebelum_lulus">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="number" value="{{ $tabel_8_d_1_a->jltwtmp_wt_3_bulan }}" name="jltwtmp_wt_3_bulan" id="jltwtmp_wt_3_bulan">
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="jltwtmp_3_wt_6_bulan" class="col-md-2 col-form-label">3 ≤ WT ≤ 6 bulan</label>
                        <div class="col-md-10">
                            <input class="form-control" type="number" value="{{ $tabel_8_d_1_a->jltwtmp_3_wt_6_bulan }}" name="jltwtmp_3_wt_6_bulan" id="jltwtmp_3_wt_6_bulan">
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="jltwtmp_wt_6_bulan" class="col-md-2 col-form-label">WT > 6 bulan</label>
                        <div class="col-md-10">
                            <input class="form-control" type="number" value="{{ $tabel_8_d_1_a->jltwtmp_wt_6_bulan }}" name="jltwtmp_wt_6_bulan" id="jltwtmp_wt_6_bulan">
                        </div>
                    </div>
