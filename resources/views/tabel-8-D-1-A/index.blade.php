...
<button class="btn btn-success mb-4">
    <a href="{{ route('tabel-8-d-1-a.create') }}" class="text-white">Tambah</a>
</button>
    ...
    $(function() {
        ...
        var table = $('.data-table').DataTable({
            ...
            columns: [{
                ...
                {
                    data: 'jltwtmp_wt_3_bulan',
                    name: 'jltwtmp_wt_3_bulan'
                },
                {
                    data: 'jltwtmp_3_wt_6_bulan',
                    name: 'jltwtmp_3_wt_6_bulan'
                },
                {
                ...
                {
                    data: 'jumlah_lulusan_yang_dipesan_sebelum_lulus',
                    name: 'jumlah_lulusan_yang_dipesan_sebelum_lulus',
                },
                {
                    data: 'action',
                    name: 'action',
