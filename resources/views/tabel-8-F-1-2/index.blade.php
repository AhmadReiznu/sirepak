...
@slot('title') Pagelaran/Pameran/Presentasi/Publikasi Ilmiah Mahasiswa @endslot
@endcomponent

<button class="btn btn-success mb-4">
    <a href="{{ route('tabel-8-f-1-2.create') }}" class="text-white">Tambah</a>
</button>
