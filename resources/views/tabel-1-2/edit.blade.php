            ...
            <form action="{{ route('tabel-1-2.update', $tabel_1_2->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3 mt-3 row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="text" name="lembaga_mitra" value="{{ $tabel_1_2->lembaga_mitra }}" id="lembaga">
                        </div>
                    </div>
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <select name="tingkat" class="form-select">
                                <option value="{{ $tabel_1_2->tingkat }}">{{ $tabel_1_2->tingkat }}</option>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="text" value="{{ $tabel_1_2->judul_kegiatan_kerjasama }}" name="judul_kegiatan_kerjasama" id="judul_kegiatan">
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="manfaat_ps" class="col-md-2 col-form-label">Manfaat bagi PS yang Diakreditasi</label>
                        <div class="col-md-10">
                            <input class="form-control" type="text" name="manfaat_bagi_ps_yang_diakreditasi" value="{{ $tabel_1_2->manfaat_bagi_ps_yang_diakreditasi }}" id="manfaat_ps">
                        </div>
                    </div>
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <div class="input-group">
                                <input type="number" class="form-control" name="waktu_dan_durasi" value="{{ $tabel_1_2->waktu_dan_durasi }}" id="waktu_durasi">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <p>File yang sudah diunggah : </p><span>{{ asset('dokumen/'.$tabel_1_2->bukti_kerjasama) }}</span>
                            <input class="form-control" type="file" name="bukti_kerjasama" value="{{ $tabel_1_2->bukti_kerjasama }}" id="bukti_kerjasama">
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="tahun_akhir_kerjasama" class="col-md-2 col-form-label">Tahun Berakhirnya Kerjasama</label>
                        <div class="col-md-10">
                            <input class="form-control" type="date" name="tahun_berakhirnya_kerjasama" value="{{ $tabel_1_2->tahun_berakhirnya_kerjasama }}" id="tahun_akhir_kerjasama">
                        </div>
                    </div>
