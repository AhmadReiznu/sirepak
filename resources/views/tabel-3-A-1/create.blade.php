...
<div class="row">
    <div class="col-12">
        ...
        <div class="card">
            <form action="{{ route('tabel-3-a-1.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <h4 class="card-title">Tambah Data Dosen Tetap Perguruan Tinggi</h4>
                    <div class="mb-3 row">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="number" name="nidn" id="nidn">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="text" name="pendidikan_pasca_sarjana_magister" id="pendidikan_pasca_sarjana_magister">
                        </div>
                    </div>
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="text" name="pendidikan_pasca_sarjana_doktor" id="pendidikan_pasca_sarjana_doktor">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="text" name="sertifikat_kompetensi_profesi_industri" id="sertifikat_kompetensi_profesi_industri">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="text" name="kesesuaian_bidang_keahlian_dengan_mata_kuliah_yang_diampu" id="kesesuaian_bidang_keahlian_dengan_mata_kuliah_yang_diampu">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="text" name="mata_kuliah_yang_diampu_pada_ps_lain" id="mata_kuliah_yang_diampu_pada_ps_lain">
                        </div>
                    </div>
