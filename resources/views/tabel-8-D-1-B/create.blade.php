...
<div class="row">
    <div class="col-12">
        ...
        <div class="card">
            <form action="{{ route('tabel-8-d-1-b.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                    <h4 class="card-title">Tambah Data Waktu Tunggu Lulusan</h4>
                    <span class="badge bg-danger">Diisi oleh pengusul dari Program Studi pada Program Sarjana</span>
                    <div class="mb-3 row">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="number" name="jltwtmp_6_wt_18_bulan" id="jltwtmp_6_wt_18_bulan">
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="jltwtmp_wt_18_bulan" class="col-md-2 col-form-label">WT > 18 bulan</label>
                        <div class="col-md-10">
                            <input class="form-control" type="number" name="jltwtmp_wt_18_bulan" id="jltwtmp_wt_18_bulan">
                        </div>
                    </div>
