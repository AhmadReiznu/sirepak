...
<div class="row">
    <div class="col-12">
        ...
        <div class="card">
            <form action="{{ route('tabel-8-f-1-1.update', $tabel_8_f_1_1->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="card-body">
                    @if(count($errors) > 0)
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="number" value="{{ $tabel_8_f_1_1->jumlah_judul_ts_2 }}" name="jumlah_judul_ts_2" id="jumlah_judul_ts_2">
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="jumlah_judul_ts_1" class="col-md-2 col-form-label">TS-1</label>
                        <div class="col-md-10">
                            <input class="form-control" type="number" value="{{ $tabel_8_f_1_1->jumlah_judul_ts_1 }}" name="jumlah_judul_ts_1" id="jumlah_judul_ts_1">
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="jumlah_judul_ts" class="col-md-2 col-form-label">TS</label>
                        <div class="col-md-10">
                            <input class="form-control" type="number" value="{{ $tabel_8_f_1_1->jumlah_judul_ts }}" name="jumlah_judul_ts" id="jumlah_judul_ts">
                        </div>
                    </div>
