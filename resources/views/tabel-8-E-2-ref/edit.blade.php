...
<div class="row">
    <div class="col-12">
        ...
        <div class="card">
            <form action="{{ route('tabel-ref-8-e-2.update', $tabel_ref_8_e_2->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="card-body">
                    @if(count($errors) > 0)
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="number" value="{{ $tabel_ref_8_e_2->jumlah_lulusan }}" name="jumlah_lulusan" id="jumlah_lulusan">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-10">
                            <input class="form-control" type="number" value="{{ $tabel_ref_8_e_2->jumlah_tanggapan_kepuasan_pengguna_yang_terlacak }}" name="jumlah_tanggapan_kepuasan_pengguna_yang_terlacak" id="jumlah_tanggapan_kepuasan_pengguna_yang_terlacak">
                        </div>
                    </div>
